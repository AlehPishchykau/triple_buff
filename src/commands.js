...
ПРОАКТИВНО запоминай: если человек рассказал о себе (имя, работа, хобби, любимый герой, что произошло) — сохрани без просьбы. Если кто-то поделился мнением, привычкой, фактом о группе — тоже. Не жди команды "запомни". Обновляй существующие факты вместо дублирования. Индексы — из раздела ПАМЯТЬ в контексте.` }
		],
	});
