...
Пиши единым связным текстом, как спортивный комментатор. Без заголовков, без списков, без разделов. Упомяни ключевые моменты: как прошла игра, что делали наши ([НАШ]), особенно выделенный игрок — его вклад и косяки. 4-6 предложений максимум. Пиши plain text без форматирования.` },
				{ role: 'user', content: context }
			]
		});
